...
Création d'un tableau de bord graphique (dji_rapport_analyse.png) montrant le spectrogramme (Waterfall), l'occupation spectrale (pics à 5785 MHz et 5814 MHz) et le profil de puissance.
...
Saturation du rapport signal-sur-bruit (SNR) du récepteur cible. Sur un drone type Furtif IRDRONE, cela entraîne la perte du flux vidéo puis le déclenchement de la procédure de sécurité (RTH ou atterrissage).
...
Complexité : L'utilisation de l'OFDM nécessite une puissance de saturation élevée ou l'ajout d'un amplificateur de puissance externe (+20 dB).
